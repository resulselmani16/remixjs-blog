...
function AdminPost() {
  ...
  const { post: post2, html } = useLoaderData();
  const [postTitle, setPostTitle] = (0, import_react2.useState)(post2.title);
  const [postSlug, setPostSlug] = (0, import_react2.useState)(post2.slug);
  const [postMarkdown, setPostMarkdown] = (0, import_react2.useState)(post2.markdown);
  const errors = useActionData();
  const params = useParams();
  const handleSubmit = ({ title, slug, markdown }) => {
    post2.title = title;
    post2.slug = slug;
    post2.markdown = markdown;
  };
  const handleEditClick = () => {
    if (params.slug === post2.slug) {
      setIsEditMode(false);
    }
  };
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
              onClick: () => (0, import_post.deletePost)(post2),
...
//# sourceMappingURL=/build/routes/posts/admin/$slug-FA42HRZP.js.map
