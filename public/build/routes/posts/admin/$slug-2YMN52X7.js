...
function AdminPost() {
  ...
  const [params, setParams] = (0, import_react2.useState)(useParams());
  const [postMarkdown, setPostMarkdown] = (0, import_react2.useState)(post.markdown);
  const errors = useActionData();
  console.log(params);
  const updatedParams = (0, import_react2.useEffect)(() => {
    setParams();
  });
...
//# sourceMappingURL=/build/routes/posts/admin/$slug-2YMN52X7.js.map
