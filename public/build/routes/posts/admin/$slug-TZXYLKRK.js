...
function NewPost() {
  ...
  const isCreating = ((_a = transition.submission) == null ? void 0 : _a.formData.get("intent")) === "delete";
  const isUpdating = (_b = transition.submission) == null ? void 0 : _b.formData.get("intent");
...
//# sourceMappingURL=/build/routes/posts/admin/$slug-TZXYLKRK.js.map
