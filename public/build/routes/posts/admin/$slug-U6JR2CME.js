            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", {
                  ...
                  className: `${hasMargin ? "margin-right-none" : "margin-right"} ${isValid ? "bg-blue-500 hover:bg-blue-600 focus:bg-blue-400 disabled:bg-blue-300" : "bg-blue-500 hover:bg-blue-600 focus:bg-blue-400 disabled:bg-blue-300"} rounded  py-2 px-4 text-white disabled:bg-blue-300`,
...
//# sourceMappingURL=/build/routes/posts/admin/$slug-U6JR2CME.js.map
